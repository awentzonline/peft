...
class HRRAAModel(nn.Module):
    ...
    def __init__(self, model, configs: Dict, adapter_name: str):
        ...
        self.peft_config: Dict[str, HRRAAConfig] = {}
        ...
        self._mark_only_hrraa_as_trainable(self.model)

    def add_adapter(self, adapter_name: str, config: HRRAAConfig) -> None:
    ...
    def _mark_only_hrraa_as_trainable(self, model: nn.Module) -> None:
        """Freeze all parameters of the model except the HRRAA params."""
        for n, p in model.named_parameters():
            print(n, is_hrraa_trainable(n))
            if not is_hrraa_trainable(n):
